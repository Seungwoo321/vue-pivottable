<template><div><h1 id="스타일링" tabindex="-1"><a class="header-anchor" href="#스타일링"><span>스타일링</span></a></h1>
<h2 id="스타일링-방법" tabindex="-1"><a class="header-anchor" href="#스타일링-방법"><span>스타일링 방법</span></a></h2>
<p>매우 간단합니다. dist에서 스타일을 가져온 다음 새 스타일을 정의하세요.</p>
<h2 id="예제" tabindex="-1"><a class="header-anchor" href="#예제"><span>예제</span></a></h2>
<h3 id="bootstrap-v5-2-2" tabindex="-1"><a class="header-anchor" href="#bootstrap-v5-2-2"><span>Bootstrap v5.2.2</span></a></h3>
<iframe
...
<details class="hint-container details"><summary>세부사항</summary>
...
<h3 id="vuexy-ui-템플릿-부트스트랩-기반" tabindex="-1"><a class="header-anchor" href="#vuexy-ui-템플릿-부트스트랩-기반"><span>Vuexy UI 템플릿 (부트스트랩 기반)</span></a></h3>
<ul>
<li><a href="https://pixinvent.com/demo/vuexy-vuejs-admin-dashboard-template/demo-3/table/bs-table" target="_blank" rel="noopener noreferrer">https://pixinvent.com/demo/vuexy-vuejs-admin-dashboard-template/demo-3/table/bs-table</a></li>
</ul>
<iframe
