<template><div><h1 id="styling" tabindex="-1"><a class="header-anchor" href="#styling"><span>Styling</span></a></h1>
<h2 id="how-to-styling" tabindex="-1"><a class="header-anchor" href="#how-to-styling"><span>How to Styling?</span></a></h2>
<p>This is very simple. Import the style from the dist and then define a new style.</p>
...
<h3 id="vuexy-ui-template-bootstrap-based" tabindex="-1"><a class="header-anchor" href="#vuexy-ui-template-bootstrap-based"><span>Vuexy UI Template (bootstrap based)</span></a></h3>
<ul>
