...
export default {
  ...
  methods: {
    ...
    updateAgregator (field, aggregatorName) {
      const index = this.propsData.selectedAggregators.findIndex(([, attribute]) => attribute === field)
  ...
  render (h) {
    ...
    const aggregatorCell = this.aggregatorCell(this.propsData.selectedAggregators, h)
