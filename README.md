...
|aggregators|`Object` of functions<br><br>`aggregators` from `Utilities`|dictionary of generators for aggregation functions in dropdown (see [original PivotTable.js documentation](https://github.com/nicolaskruchten/pivottable/wiki/Aggregators))
